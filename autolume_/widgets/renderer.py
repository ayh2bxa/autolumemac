...
from modules.network_utils import extract_conv_names, extract_mapping_names
import os
import pickle
...
class Renderer:
    ...
    def set_pkl(self, pkl_path):
        """Load a StyleGAN model from a pickle file"""
        self.pkl = pkl_path
        self.G = self.get_network(pkl_path, 'G_ema')
